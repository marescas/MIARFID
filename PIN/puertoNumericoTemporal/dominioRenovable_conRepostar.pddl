...
(:functions 
    (peso ?c1 - contenedor)
    (conaltura ?a1 - nivel)
    (tiempoTransporteLento)
    (tiempoTransporteRapido)
    (consumoTransporteLento)
    (consumoTransporteRapido)
    (gasolinaDisponible)
    (totalGastado)
    (tamanyoDeposito)
    (tiempoRepostar)
...
(:durative-action repostar
    ...
    :effect (and
        (at end (assign (gasolinaDisponible) (tamanyoDeposito))) ; repostamos hasta su capacidad maxima
    )
)
