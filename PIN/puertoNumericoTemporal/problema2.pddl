...
(:init
    ...
    (= (tiempoTransporteLento) 20)
    (= (tiempoTransporteRapido) 10)
    (= (consumoTransporteLento) 100)
    (= (consumoTransporteRapido) 200)
    ;
    (= (gasolinaDisponible) 500)
    (= (totalGastado) 0)
    (= (tamanyoDeposito) 600)
...
;metrica a minimizar
(:metric minimize (total-time)) ;totalGastado
)
